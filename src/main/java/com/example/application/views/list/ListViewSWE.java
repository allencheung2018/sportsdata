...
import com.example.application.data.repository.SWERepository;
...
@PageTitle("SWE | Sports")
@Route(value = "SWE", layout = MainLayout.class)
@Slf4j
public class ListViewSWE extends ListView {
    final static private String nameLeague = "Portugal Primeira Liga";
    final private SWERepository repository;
    Pair<Date, Date> pair;
    ...
    public ListViewSWE(SWERepository repository, DataService dataService) {
        super();
