...
import com.example.application.data.repository.N_1Repository;
...
@PageTitle("N1 | Sports")
@Route(value = "N1", layout = MainLayout.class)
@Slf4j
public class ListViewN1 extends ListView {

    final static private String nameLeague = "Netherlands Eredivisie";
    final private N_1Repository repository;
    Pair<Date, Date> pair;
    ...
    public ListViewN1(N_1Repository repository, DataService dataService) {
        super();
