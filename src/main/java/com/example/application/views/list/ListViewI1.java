...
import com.example.application.data.repository.I_1Repository;
...
@PageTitle("I1 | Sports")
@Route(value = "I1", layout = MainLayout.class)
@Slf4j
public class ListViewI1 extends ListView {

    final static private String nameLeague = "Italy Serie A";
    final private I_1Repository repository;
    Pair<Date, Date> pair;
    ...
    public ListViewI1(I_1Repository repository, DataService dataService) {
        super();
