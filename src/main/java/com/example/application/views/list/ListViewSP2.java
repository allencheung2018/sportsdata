...
import com.example.application.data.repository.SP_2Repository;
...
@PageTitle("SP2 | Sports")
@Route(value = "SP2", layout = MainLayout.class)
@Slf4j
public class ListViewSP2 extends ListView {
    ...
    public ListViewSP2(SP_2Repository repository, DataService dataService) {
        super();
