...
import com.example.application.data.repository.F_1Repository;
...
@PageTitle("F1 | Sports")
@Route(value = "F1", layout = MainLayout.class)
@Slf4j
public class ListViewF1 extends ListView {

    final static private String nameLeague = "France Ligue I";
    final private F_1Repository repository;
    Pair<Date, Date> pair;
    ...
    public ListViewF1(F_1Repository repository, DataService dataService) {
        super();
